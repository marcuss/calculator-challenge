...
/**
 * REST controller for managing {@link pro.marcuss.calculator.domain.Operation}.
 */
@RestController
...
public class OperationResource {
    ...
    public ResponseEntity<OperationDTO> updateOperation(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, operationDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<OperationDTO> partialUpdateOperation(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, operationDTO.getId())
        );
    }
