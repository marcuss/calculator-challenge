...
describe('Component Tests', () => {
  describe('Operation Management Component', () => {
    ...
    it('Should call load all on init', async () => {
      // GIVEN
      operationServiceStub.retrieve.resolves({ headers: {}, data: [{ id: 'ABC' }] });
      ...
      expect(comp.operations[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
    });
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      ...
      // THEN
      expect(operationServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(operationServiceStub.retrieve.callCount).toEqual(3);
