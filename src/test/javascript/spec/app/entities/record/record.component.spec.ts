...
describe('Component Tests', () => {
  describe('Record Management Component', () => {
    ...
    it('Should call load all on init', async () => {
      // GIVEN
      recordServiceStub.retrieve.resolves({ headers: {}, data: [{ id: 'ABC' }] });
      ...
      expect(comp.records[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
    });
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(recordServiceStub.retrieve.callCount).toEqual(1);
