...
class AccountResourceIT extends AbstractIntegrationTest {
    ...
    void testNonAuthenticatedUser() throws Exception {
        restAccountMockMvc
            .perform(get("/api/v1/authenticate").accept(MediaType.APPLICATION_JSON))
    ...
    void testGetUnknownAccount() throws Exception {
        restAccountMockMvc
            .perform(get("/api/v1/account").accept(MediaType.APPLICATION_PROBLEM_JSON))
    ...
    void testRegisterValid() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/v1/register").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(validUser)))
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/v1/register").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(invalidUser)))
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        // First user
        restAccountMockMvc
            .perform(post("/api/v1/register").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(firstUser)))
            .andExpect(status().isCreated());

        // Second (non activated) user
        restAccountMockMvc
            .perform(post("/api/v1/register").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(secondUser)))
            .andExpect(status().isCreated());
    ...
    void testActivateAccount() throws Exception {
        ...
        restAccountMockMvc.perform(get("/api/v1/activate?key={activationKey}", activationKey)).andExpect(status().isOk());
    ...
    void testActivateAccountWithWrongKey() throws Exception {
        restAccountMockMvc.perform(get("/api/v1/activate?key=wrongActivationKey")).andExpect(status().isInternalServerError());
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/v1/account").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(userDTO)))
            .andExpect(status().isOk());
    ...
    void testRequestPasswordReset() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/v1/account/reset-password/init").content("password-reset@example.com"))
            .andExpect(status().isOk());
    }
    ...
    void testRequestPasswordResetUpperCaseEmail() throws Exception {
        ...
        restAccountMockMvc
            .perform(post("/api/v1/account/reset-password/init").content("password-reset-upper-case@EXAMPLE.COM"))
            .andExpect(status().isOk());
    }
    ...
    void testRequestPasswordResetWrongEmail() throws Exception {
        restAccountMockMvc
            .perform(post("/api/v1/account/reset-password/init").content("password-reset-wrong-email@example.com"))
            .andExpect(status().isOk());
    }
