...
import pro.marcuss.calculator.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    void createUser() throws Exception {
        ...
        restUserMockMvc
            .perform(
                post("/api/v1/admin/users").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(managedUserVM))
            )
    ...
    void getAllUsers() throws Exception {
        ...
        // Get all the users
        restUserMockMvc
            .perform(get("/api/v1/admin/users").accept(MediaType.APPLICATION_JSON))
    ...
    void getUser() throws Exception {
        ...
        // Get the user
        restUserMockMvc
            .perform(get("/api/v1/admin/users/{login}", user.getLogin()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void getNonExistingUser() throws Exception {
        restUserMockMvc.perform(get("/api/v1/admin/users/unknown")).andExpect(status().isNotFound());
    }
    ...
    void updateUser() throws Exception {
        ...
        restUserMockMvc
            .perform(
                put("/api/v1/admin/users").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(managedUserVM))
            )
            .andExpect(status().isOk());
    ...
    void deleteUser() throws Exception {
        ...
        // Delete the user
        restUserMockMvc
            .perform(delete("/api/v1/admin/users/{login}", user.getLogin()).accept(MediaType.APPLICATION_JSON))
